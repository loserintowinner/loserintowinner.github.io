...
<div align="center">
<img src="../assets/TCP.assets/tls性能损耗.png" alt="img" style="zoom:67%;" />
</div>
...
![img](../assets/TCP.assets/aesni_intel.png)
...
![img](../assets/TCP.assets/ssl_ecdh_curve.png)
...
![img](../assets/TCP.assets/ssl_ciphers.png)
...
![img](../assets/TCP.assets/tls1.2and1.3.png)
...
![img](../assets/TCP.assets/ocsp.png)
...
![img](../assets/TCP.assets/opscp-stapling.png)
...
![img](../assets/TCP.assets/sessionid.png)
...
![img](../assets/TCP.assets/ticket.png)
...
![img](../assets/TCP.assets/重放攻击.png)
...
![img](../assets/TCP.assets/0-RTT.png)

同样的，Pre-shared Key 也有重放攻击的危险。

![img](../assets/TCP.assets/0-rtt-attack.png)
