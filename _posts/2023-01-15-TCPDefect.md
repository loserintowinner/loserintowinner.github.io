...
![img](../assets/TCP.assets/TCP%2BTLS.gif)

TCP 三次握手的延迟被 TCP Fast Open （快速打开）这个特性解决了，这个特性可以在「第二次建立连接」时减少 TCP 连接建立的时延。

![常规 HTTP 请求 与 Fast  Open HTTP 请求](../assets/TCP.assets/45-16793915585782.jpg)
...
![img](../assets/TCP.assets/Apo6LQIBU7zIAAAAAAAAAAAAAARQnAQ.png)
...
![img](../assets/TCP.assets/tcp队头阻塞.gif)
...
![img](../assets/TCP.assets/v2-2dd2a9fb8693489b9a0b24771c8a40a1_1440w.jpg)
...
![TCP 四元组](../assets/TCP.assets/format,png.png)
...
![img](../assets/TCP.assets/1uk5OZPL7gtUwqRLwaoGyFw.png)